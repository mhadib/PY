...
logging.basicConfig(filename='E:/گزارشات لاگ ها/Economist/FilterBoursePlus.txt', level=logging.DEBUG,
...
try:
    ...
    test2df = pandas.read_excel(r'E:\PY\Economist\کدوم_دسته_از_بورسها_رو_میخوای؟.xlsx', sheet_name='Sheet1')
