...
logging.basicConfig(filename='E:/گزارشات لاگ ها/BalanceSheet/BalanSheetTalfighi_Cashflow_Farabourse_Log.txt', level=logging.DEBUG,
...
try:
    ...
    finalResult.to_sql("BalanceSheetTalfighiCategurCashflow_Farabourse", con=engine, index=False, if_exists='append')
    print("end of write to sql ")

    print("start to write to files ")
    finalResult.to_excel('E:\\گزارشات اکسل\\BourseView\\BalanceSheet\\BalanceSheetTalfighiCategurCashflow_Farabourse.xlsx', index=False)
