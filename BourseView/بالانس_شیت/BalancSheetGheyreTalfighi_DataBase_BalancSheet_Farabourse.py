...
logging.basicConfig(filename='E:/گزارشات لاگ ها/BalanceSheet/BalanSheetGheyreTalfighiLog_BalanceSheet_Farabourse.txt', level=logging.DEBUG,
...
try:
    ...
    finalResult.to_sql("BalanceSheetGheyreTalfighiCategurbalancesheet_Farabourse", con=engine, index=False, if_exists='append')
    print("end of write to sql ")

    print("start to write to files ")
    finalResult.to_excel('E:\\گزارشات اکسل\\BourseView\\BalanceSheet\\BalanceSheetGheyreTalfighiCategurbalancesheet_Farabourse.xlsx', index=False)
