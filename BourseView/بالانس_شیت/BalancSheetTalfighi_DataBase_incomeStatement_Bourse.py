...
logging.basicConfig(filename='E:/گزارشات لاگ ها/BalanceSheet/BalanSheetTalfighi_Incomestatement_Bourse_Log.txt', level=logging.DEBUG,
...
try:
    ...
    finalResult.to_sql("BalanceSheetTalfighiCategurincomestatement_Bourse", con=engine, index=False, if_exists='append')
    print("end of write to sql ")

    print("start to write to files ")
    finalResult.to_excel('E:\\گزارشات اکسل\\BourseView\\BalanceSheet\\BalanceSheetTalfighiincomestatement_Bourse.xlsx', index=False)
