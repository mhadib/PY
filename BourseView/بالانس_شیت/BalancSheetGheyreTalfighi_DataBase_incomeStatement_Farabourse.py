...
logging.basicConfig(filename='E:/گزارشات لاگ ها/BalanceSheet/BalanSheetGheyreTalfighi_IncomeStatement_Farabourse_Log.txt', level=logging.DEBUG,
...
try:
    ...
    finalResult.to_sql("BalanceSheetGheyreTalfighiCategurincomestatement_Farabourse", con=engine, index=False, if_exists='append')
    print("end of write to sql ")

    print("start to write to files ")
    finalResult.to_excel('E:\\گزارشات اکسل\\BourseView\\BalanceSheet\\BalanceSheetGheyreTalfighiincomestatement_Farabourse.xlsx', index=False)
