...
logging.basicConfig(filename='E:/گزارشات لاگ ها/BalanceSheet/BalanSheetGheyreTalfighi_BalanceSheet_Bourse_Log.txt', level=logging.DEBUG,
...
try:
    ...
    # StatementHelp = get_sessions2('https://api.bourseview.com/v2/statementsItems', authToken, cookies)
    ...
    finalResult.to_sql("BalanceSheetGheyreTalfighiCategurbalancesheet_bourse", con=engine, index=False, if_exists='append')
    print("end of write to sql ")

    print("start to write to files ")
    finalResult.to_excel('E:\\گزارشات اکسل\\BourseView\\BalanceSheet\\BalanceSheetGheyreTalfighiCategurbalancesheet_bourse.xlsx', index=False)
