...
logging.basicConfig(filename='E:/BourseView/Log/tsetmcStackHoldersEsmesherkat.txt', level=logging.DEBUG,
...
try:
    ...
    sqlHistory.to_excel('E:\\BourseView\\Excels\\tsetmcStackHoldersEsmesherkat.xlsx', index=False)
