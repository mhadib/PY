...
class QuotesSpider(scrapy.Spider):
    ...
    custom_settings = {
        'LOG_FILE': 'E:/BourseView/Log/StackHoldersChanges.txt',
    }
    ...
    def start_requests(self):
        ...
        urls.append('http://www.tsetmc.com/Loader.aspx?ParTree=15131I&t=1')
    ...
    def parse(self, response):
        ...
        dd.to_csv("E:\\BourseView\\CSVs\\TSETMCStackHolderChanges.csv", encoding='utf-8-sig')
        print(dd)
        finalResult = pd.DataFrame()
        dd = pd.read_csv("E:\\BourseView\\CSVs\\TSETMCStackHolderChanges.csv")
        ...
        sqlHistory.to_excel('E:\\BourseView\\Excels\\StackHoldersForLastDay1Mounth6Mounth.xlsx', index=False)
